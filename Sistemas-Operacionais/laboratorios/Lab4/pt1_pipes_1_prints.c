...
int main(int argc,char *argv[]){
    ...
    // Testando a criacao dos processos:
    //printf("Eu sou %d, filho de %d!\n", getpid(), getppid());

    // ========================================================================
    if (pid > 0){   // Processo pai
        // ====================================================================
        // c) Enviando x para o Filho 1
        printf("Eu, %d, vou enviar %d, para meu filho.\n", getpid(), x);
        ...
        printf("Eu, %d, vou ler o que meu pai mandar!\n", getpid());
        if (read(fd[0][0], &y, sizeof(int)) == -1){
            printf("Erro ao ler do pipe!\n");
            return 4;
        }
        printf("Recebi do meu pai: %d\n", y);
        ...
        printf("Enviei o vetor para meu irmao.\n");
        ...
        printf("Recebi o que meu irmao mandou!\n");

        int soma = 0;
        for (int i = 0; i < arr_size2; i++){
            soma += arr2[i];
        }
        printf("Somei: %d, e vou mandar pro meu pai!\n", soma);
